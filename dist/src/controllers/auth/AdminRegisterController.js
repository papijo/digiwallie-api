...
const AdminRegisterController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const encryptedPassword = Crypto.AES.encrypt(req.body.password, config_1.default.PASS_SECRET_CRYPTOJS).toString();
...
//# sourceMappingURL=AdminRegisterController.js.map